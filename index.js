...
const {rules,exclude,names}=require("./config.js")
let posts={};
let tags=[];
...
loadFolders("./posts/","").then(x=>fs.writeFileSync("./posts.json",JSON.stringify(posts,undefined,4)))
                  .then(x=>require("./modules/renderer.js")(tags))
                  .catch(x=>{console.error(x)})
                  .finally(()=>{clearInterval(timer);process.exit(0);});
